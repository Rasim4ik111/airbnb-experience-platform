...
function App() {
  ...
  return (
    <div className="min-h-screen">
      <header className="flex justify-between items-center mb-8 border-b border-gray-300 pb-4 p-8 bg-gray-200">
        <svg
          width="102"
          height="32"
        ...
        <div className="flex  items-center hover:cursor-pointer">
          <h3 className="p-2">Жилье</h3>
          <h3 className="p-2">Впечатления</h3>
          <h3 className="p-2">Услуги</h3>
        </div>
      ...
      <section className="p-8 flex flex-wrap">
        <PropertyList
